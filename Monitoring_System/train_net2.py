...
def net2(X, weights, biases, drop_out):
...
# load_label_train = scio.loadmat('./ImageSet/Face_Gray/A/label_train_A_net2.mat')
# dataA = load_data_train.get('data_train_A')
# labelA = load_label_train.get('label_train_A_net2')
# load_data_train = scio.loadmat('./ImageSet/Face_Gray/B/data_train_B.mat')
# load_label_train = scio.loadmat('./ImageSet/Face_Gray/B/label_train_B_net2.mat')
# dataB = load_data_train.get('data_train_B')
# labelB = load_label_train.get('label_train_B_net2')
# load_data_train = scio.loadmat('./ImageSet/Face_Gray/C/data_train_C.mat')
# load_label_train = scio.loadmat('./ImageSet/Face_Gray/C/label_train_C_net2.mat')
# dataC = load_data_train.get('data_train_C')
# labelC = load_label_train.get('label_train_C_net2')
# load_data_train = scio.loadmat('./ImageSet/Face_Gray/D/data_train_D.mat')
# load_label_train = scio.loadmat('./ImageSet/Face_Gray/D/label_train_D_net2.mat')
# dataD = load_data_train.get('data_train_D')
# labelD = load_label_train.get('label_train_D_net2')
# load_data_train = scio.loadmat('./ImageSet/Face_Gray/F/data_train_F.mat')
# load_label_train = scio.loadmat('./ImageSet/Face_Gray/F/label_train_F_net2.mat')
# dataF = load_data_train.get('data_train_F')
# labelF = load_label_train.get('label_train_F_net2')
...
indexB, dataB, labelB = Get_data.loadimg(class_fold='B', label_index=1)
indexC, dataC, labelC = Get_data.loadimg(class_fold='C', label_index=2)
...
logits = net2(X, weights, biases, keep_prob)
...
str1 = 'train_loss'
str2 = 'train_accuracy'
dataNew1 = './model/loss_mat/train_loss_net2.mat'
dataNew2 = './model/loss_mat/train_accuracy_net2.mat'
